        ...
        <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
            ...
            <div className='md:w-1/2 space-y-8 h-full'>
                ...
                <p className='md:w-4/5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Quidem, accusamus quae nihil possimus tempora ullam non dolore totam quibusdam sapiente ea! Facere ratione 
                    perspiciatis facilis! Aut eveniet sapiente quo aliquam.</p>
                <div>
